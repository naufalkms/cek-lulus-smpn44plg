    ...
    <div class="col-12">
        ...
        <div class="card box-shadow-0 border-info">
            <div class="card-header card-head-inverse bg-secondary">
                <h3 class="card-title text-center">Tambah Data Siswa</h3>
            </div>
                ...
                <div class="card-body card-dashboard">
                    ...
                    <form method="post" action="/student">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tempat_tgl_lahir" class="form-control" value="{{ old('tempat_tgl_lahir') }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control" required>
                                <option value="1" {{ old('status') == '1' ? 'selected' : '' }}>Lulus</option>
                                <option value="2" {{ old('status') == '2' ? 'selected' : '' }}>Ditunda</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Pesan</label>
